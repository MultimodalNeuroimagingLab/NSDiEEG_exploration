...
%{
 {["LOC6", "LOC7", "LOC8"],...
 ["RLS1", "RLS2", "RLI1", "RLI2","RLI3","RLI4","RLI5","RLI6","RLM4", "RLM5", "RLM8"],...
["RPO1","RPO2","RPO3","RPO4","RPO5","RPA1","RPA2","RPA3","RPA4","RPA5"],...
 ["LOC12","LOC13"],["ROC7", "ROC8", "ROC10", "ROC11","ROC12"], ["ROC7", ...
 "ROC8", "ROC9", "ROC10", "ROC11"],["LOc9"]};
...
{["RBC6","RBC7", "LOC1", "LOC2", "LOC3", "LOC4", "LOC5", "LOC6", "LOC7", "LOC8"],...
    ...
    "LT1","LT6", "LB6", "LB7", "LT7","LT8","LT9","LT10","LT11"],...
    ["LOC1", "LOC2", "LOC3","LOC4", "LOC5", "LB6", "LB7", "LOC6","LOC7","LOC8",...
    "LOC9","LOC10","LOC11","LOC12"]};
%}
%Lateral Stream only (SNR > 0.2):
 %{
{["LOC6", "LOC7", "LOC8"],...
 ["RLS1", "RLS2", "RLI1", "RLI2","RLI3","RLI4","RLI5","RLI6","RLM4", "RLM5", "RLM8"],...
["RPO1","RPO2","RPO3","RPO4","RPO5","RPA1","RPA2","RPA3","RPA4","RPA5"],...
 ["LOC12","LOC13"],[],[]};
 %{[], ["ROC7", "ROC8", "ROC10", "ROC11","ROC12"], ["ROC7", ...
  %  "ROC8", "ROC9", "ROC10", "ROC11"],[],["LOc9"],[]};
 %}    
...
for k=1:length(subject)
    ...
    for i = 1:length(subChannel)
        ...
        for j = 1:length(folderName)
           ...
           % Checks that the folder lengths are the same
            if (length(folderName) == 2) 
